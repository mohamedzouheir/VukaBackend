...
![Today page: counts, the three highest-risk entities, quick actions and tasks](img/j3-01-today.png)
...
- **My tasks** on the right: work set for you, with due dates.
...
![Risk explanation panel for Robben Island Museum, showing the five signals](img/j3-03-why.png)

The five signals are submission lateness, evidence gap, spend running ahead of delivery, prior
audit findings, and targets restated mid-year. The executive sees exactly the same explanation.
...
Click **Return with comments**. Vuka lists each disputed figure with your comment. Add an overall
note if it helps, then click **Return 1 figure** (or however many you disputed).
...
Open a submission you are satisfied with and click **Approve**. The dialog warns you how many
figures have no evidence: they stay on the record as unverifiable, and approving does not change
that. Click **Approve** to confirm.
