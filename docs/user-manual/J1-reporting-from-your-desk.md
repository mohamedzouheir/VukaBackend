...
![Upload page with the file chosen and Upload and parse marked](img/j1-02-upload.png)

Vuka reads the file and tells you how many rows it read and how many matched a registered
target (3).

![Upload result: 21 rows read, 20 matched, one held aside](img/j1-03-parsed.png)
...
![Review page with the warning, the figure and its source cell, and the attach link marked](img/j1-04-review.png)
...
![Submit dialog summarising the submission](img/j1-14-submit-modal.png)
...
![Home page after submitting, 20 of 20 targets reported](img/j1-15-submitted.png)
...
![The reopened figure with the Department's comment](img/j1-17-answer.png)
