...
export const en = {
  ...
  'docs.searchLabel': 'Search documents by file name or uploader',
  'docs.searchPlaceholder': 'Search by file name or uploader...',
  'docs.filterType': 'Document type',
  'docs.allTypes': 'All types',
  'docs.allDecisions': 'All decisions',
  'docs.filterYear': 'Year',
  'docs.allYears': 'All years',
  'docs.clearFilters': 'Clear filters',
  'docs.filesCount': 'Files ({0})',
  'docs.sortBy': 'Sort by',
  'docs.sortNewest': 'Newest first',
  'docs.sortOldest': 'Oldest first',
  'docs.sortName': 'Name, A to Z',
  'docs.noMatch': 'No document matches these filters.',
  'docs.helpHead': 'Finding a document',
  'docs.helpBody': 'Search by file name or uploader, or narrow the list by type, decision and year. Every version stays on record, so an older file is still here after a newer one replaces it.',
  'docs.recentHead': 'Recently receipted',
  'docs.recentEmpty': 'Nothing has been receipted yet.',
  'docs.typeStrategicPlan': 'Strategic plan',
  'docs.typeApp': 'Annual performance plan',
  'docs.typeOperationalPlan': 'Operational plan',
  'docs.typeAnnualReport': 'Annual report',
  'docs.typeQuarterlyReport': 'Quarterly report',
  'docs.typeFinancials': 'Financial statements',
  'docs.typeTemplate': 'Reporting template',
  'docs.typeUnstated': 'Type not stated',
  'docs.chooseNote':
  ...
  'pf.greetingSub': 'Here is where the Department\'s public entities stand.',
  'pf.periodPick': 'Reporting period',
  'pf.tileBodies': 'Public entities',
  'pf.tileBodiesSub': '{0} public entities, {1} NPOs',
  'pf.tileFiled': 'Filed for {0}',
  'pf.countOfEntities': '{0} of {1} entities',
  'pf.tileRisk': 'High or critical risk',
  'pf.countOfScored': '{0} of {1} scored entities',
  'pf.tileToFile': 'Still to file for {0}',
  'pf.ringTitle': 'Risk across the portfolio',
  'pf.ringCentreSub': 'at low risk',
  'pf.ringLabel': '{0} of {1} scored entities are at low risk',
  'pf.lineTitle': 'Targets achieved, year on year',
  'pf.lineHint': 'Audited performance, from the Auditor-General\'s published outcomes',
  'pf.lineLabel': 'Share of targets achieved, by audited financial year',
  'pf.lineNotAudited': 'not audited',
  'pf.lineDetail': '{0}: {1} of {2} targets achieved, across {3} entities',
  'pf.allocTitle': 'Allocation by year',
  'pf.allocHint': 'Estimates of National Expenditure, Vote 37',
  'pf.allocLabel': 'Allocation to funded entities, by financial year',
  'pf.allocDetail': '{0}: {1} to {2} entities',
  'pf.tableTitle': 'Entity performance',
  'pf.viewAllEntities': 'View all entities',
  'pf.colEntity': 'Entity',
  'pf.colSector': 'Sector',
  'pf.colFiling': '{0} filing',
  'pf.colRisk': 'Risk score',
  'pf.colIssue': 'Largest factor',
  'pf.colLast': 'Last filed',
  'pf.open': 'Open',
  'pf.openEntity': 'Open {0}',
  'pf.fileNotFiled': 'Not filed',
  'pf.fileNotDue': 'Not yet due',
  'pf.fileAwaiting': 'Awaiting review',
  'pf.noIssue': 'Nothing notable',
  'pf.neverFiled': 'Never filed',
  'pf.tableFoot': 'The {0} highest risk of {1}. The rest are on the entity register.',
  'pf.insightsTitle': 'Key insights',
  'pf.insRiseTitle': 'Rising risk',
  'pf.insRise': '{0} entities scored higher than in the last period.',
  'pf.insRiseOne': '1 entity scored higher than in the last period.',
  'pf.insRiseNone': 'No entity\'s score rose since the last period.',
  'pf.insRiseLink': 'Open risk and alerts',
  'pf.insMoneyTitle': 'Money at risk',
  'pf.insMoneyLink': 'See the entities',
  'pf.insAuditTitle': 'Audit outcomes',
  'pf.insAudit': '{0} clean audits of {1} in {2}, against {3} of {4} in {5}.',
  'pf.insAuditNone': 'There are not yet two audited years to compare.',
  'pf.insAuditLink': 'View the trend',
  'pf.insTimelyTitle': 'Filing on time',
  'pf.insTimely': '{0} of {1} reports for {2} arrived on time. {3} were late and {4} were not filed.',
  'pf.insTimelyNone': 'Nothing has fallen due yet this year.',
  'pf.insTimelyLink': 'View the analytics',
  'pf.alertsTitle': 'Risk alerts',
  'pf.alertsCount': '{0} entities in the high or critical band',
  'pf.noAlerts': 'No entity is above the low band for this period.',
  'pf.viewAllAlerts': 'View all alerts',
  'pf.deadlinesTitle': 'Upcoming deadlines',
  'pf.day': 'day',
  'pf.days': 'days',
  'pf.stillToFile': '{0} of {1} still to file',
  'pf.noDeadlines': 'No reporting deadline is ahead.',
  'pf.citizenTitle': 'Citizen view',
  'pf.citizenBody': 'Approved figures for the entities the Department has chosen to publish, open to citizens, journalists and Parliament.',
  'pf.citizenWho': 'Publication is decided by the administrator. Nothing on this screen changes it.',
  'pf.citizenOpen': 'View public page',
  'pf.brandLine': 'Transparent reporting. Better decisions. A stronger South Africa.',
} as const;
