...
export const en = {
  ...
  'ms.stateSynced': 'synced',
  'ms.stateFailed': 'failed',
  'ms.statePending': 'pending',
  'ms.stateSource': 'from SharePoint',
  'ms.stateNotConfigured': 'not configured',
  'ms.openInSharePoint': 'Open in SharePoint',
  'ms.showError': 'Show error',
  'ms.hideError': 'Hide error',
  'ms.syncNow': 'Sync now',
  'ms.syncFailed': 'The sync did not run.',
  'ms.pickedNone': 'No changes to pick up.',
  'ms.pickedOne': '1 change picked up.',
  'ms.pickedMany': '{0} changes picked up.',
  'admin.msConfigure': 'Configure',
  'admin.msTitleFor': 'Microsoft 365 for {0}',
  'admin.msNotConfiguredWarning':
    'This tenant is not configured. A bind will fail until the Department sets up its Microsoft Graph connection.',
  'admin.msCheckingDocs': "Checking this entity's documents...",
  'admin.msNoDocsYet':
    'No documents are on record for this entity yet, so the binding cannot be confirmed this way. '
    + 'The tenant-wide status above is the only signal until one is uploaded or mirrored.',
  'admin.msBoundLine':
    "Bound to a Microsoft drive: {0} synced, {1} pending, {2} failed, {3} from SharePoint, going by "
    + "this entity's own documents.",
  'admin.msNotBoundLine': "Not bound to a Microsoft drive, going by this entity's own documents.",
  'admin.msBindHeading': 'Bind to a SharePoint library',
  'admin.msFieldHostname': 'Site hostname',
  'admin.msFieldPath': 'Site path',
  'admin.msFieldDriveId': 'Drive id',
  'admin.msFieldFolder': 'Folder path',
  'admin.msUseDriveId': 'Use a drive id directly instead of a site',
  'admin.msBind': 'Bind',
  'admin.msBoundTo': 'Bound to drive {0}, folder {1}.',
  'admin.msBindFailed': 'The workspace was not bound.',
  'admin.msWebhookHeading': 'Teams deadline reminders',
  'admin.msWebhookNote':
    'The webhook URL is a capability: whoever holds it can post to that channel, so it is never sent '
    + 'back once saved. This shows only whether one is set, and only for this session.',
  'admin.msWebhookCurrentLabel': 'Current state:',
  'admin.msWebhookUnknown': 'not reported by the server until you save or clear one',
  'admin.msFieldWebhookUrl': 'Webhook URL',
  'admin.msClear': 'Clear',
  'admin.msWebhookFailed': 'The webhook was not changed.',
  'admin.msSyncHeading': 'Sync',

  /* ---------------- charts, export and Ask Vuka ---------------- */
  'viz.showFigures': 'Show the figures',
  'viz.hideFigures': 'Hide the figures',
  'viz.notAvailable': 'not available',
  'viz.notReported': 'not reported',
  'an.subtitleCharts': 'Published and confirmed figures only. Every picture opens onto the table it was drawn from.',
  'an.downloadCsv': 'Download as CSV',
  'an.printPdf': 'Print or save as PDF',
  'an.sourcesSummary': 'Where every figure on this screen comes from, and what is deliberately absent',
  'an.sourcesA': 'Allocations: Estimates of National Expenditure 2026, Vote 37, Table 37.3. Audit outcomes and targets achieved: published annual reports and the Auditor-General’s briefing to the Portfolio Committee, blank where not published rather than inferred. Quarterly figures are those confirmed in Vuka by a named reporter; in this demonstration they are illustrative seed data.',
  'an.sourcesB': 'Not shown, because nothing records them: any monthly series, and document views or downloads. Year-on-year movement is computed only across entities with published counts in both years, because a rate over nine audited entities one year and sixteen the next measures who got audited rather than who improved.',
  'an.moneyAndDelivery': 'Money and delivery, year on year',
  'an.figAllocated': 'Allocated',
  'an.figAllocatedHint': 'Transfers and subsidies, Vote 37.',
  'an.figAchieved': 'Targets achieved, audited',
  'an.figAchievedHint': 'A year with no published count draws no bar.',
  'an.chartAllocationLabel': 'Allocation by financial year',
  'an.chartAchievedLabel': 'Targets achieved by financial year',
  'an.allocatedDetail': '{0}: {1}',
  'an.achievedDetail': '{0}: {1} of {2} targets achieved across {3} entities',
  'an.noPublishedCount': '{0}: no published count',
  'an.notOnRecord': 'not on record',
  'an.countsNotPublished': 'counts not published',
  'an.inYearShort': 'in year',
  'an.notAuditedShort': 'not audited',
  'an.twoChartsNote': 'The two charts are not the same population. Each year’s rate covers whichever entities published counts that year, so read them as two facts about a year, never as one ratio. The like-for-like comparison is Who moved, below.',
  'an.colOf': 'Of',
  'an.colEntitiesCounted': 'Entities counted',
  'an.colMetShort': 'Met',
  'an.colBelow': 'Below',
  'an.colNoFigure': 'No figure, reason given',
  'an.colApproved': 'Approved',
  'an.auditOutcomes': 'Audit outcomes',
  'an.figOpinions': 'Opinions per year',
  'an.figOpinionsHint': 'Best on the left. The three worst opinions share a fill; the sentence beside each bar names them separately.',
  'an.legendUnqualified': 'Unqualified',
  'an.legendWithFindings': 'Unqualified with findings',
  'an.legendWorse': 'Qualified, adverse or disclaimer',
  'an.legendOutstanding': 'Outstanding',
  'an.filing': 'Filing',
  'an.filingYear': 'Filing, {0}',
  'an.figWhoFiled': 'Who filed, and when',
  'an.figWhoFiledHint': 'Against the due date the Department set. A quarter not yet due has no late count.',
  'an.legendNotDue': 'Not yet due',
  'an.filingWords': '{0} on time, {1} late',
  'an.filingWordsNotDue': ', {0} not yet due',
  'an.filingWordsNotFiled': ', {0} not filed',
  'an.figMet': 'Figures meeting the quarter target',
  'an.figMetHint': 'Each figure against its own target’s quarter value.',
  'an.chartMetLabel': 'Share of figures meeting the quarter target, by quarter',
  'an.metDetail': '{0}: {1} of {2} figures met the quarter target',
  'an.noFiguresConfirmedFor': '{0}: no figures confirmed',
  'an.noneFiled': 'none filed',
  'an.chartSectorMoneyLabel': 'Allocation by sector',
  'an.chartSectorMetLabel': 'Share of figures meeting the quarter target, by sector',
  'an.sectorMoneyDetail': '{0}: {1} across {2} bodies',
  'an.sectorMetDetail': '{0}: {1} of {2} figures met the quarter target',
  'an.sectorNoFigures': '{0}: no figures filed',
  'an.figSectorMetHint': 'Each entity against its own targets.',
  'an.neverDivided': 'Money and delivery are drawn side by side and never divided into one another. Each entity is measured against its own targets, so the right-hand chart compares how well each sector keeps its own promises, not what its outputs are worth.',
  'an.figMovers': '{0} entities with published counts in both years',
  'an.figMoversHint': '{0} to {1} overall. {2} improved, {3} declined. Largest fall first.',
  'an.moverDetail': '{0}: {1} in {2} to {3} in {4} ({5} of {6}, then {7} of {8})',
  'an.csvTitle': 'Vuka analytics export',
  'an.csvGenerated': 'Generated',
  'an.csvCurrentYear': 'Current financial year',
  'an.csvReviewPeriod': 'Quarter under review',
  'an.csvBlankMeans': 'An empty cell means not published or not yet due. It never means nought.',
  'an.csvAllocatedRand': 'Allocated (R)',
  'an.csvAllocatedEarliest': 'Allocated, earliest year (R)',
  'an.csvEntitiesFunded': 'Entities funded',
  'an.csvEntitiesAudited': 'Entities audited',
  'an.csvTargetsTotal': 'Targets total',
  'an.csvAchievedPercent': 'Achieved %',
  'an.csvRepeatFindings': 'Repeat findings',
  'an.csvExpected': 'Expected',
  'an.csvDrafts': 'Drafts',
  'an.csvReturned': 'Returned',
  'an.csvAwaitingReview': 'Awaiting review',
  'an.csvFiguresReported': 'Figures reported',
  'an.csvFiguresApproved': 'Figures approved',
  'an.csvMetPercent': 'Met %',
  'an.csvScored': 'Scored',
  'an.csvChangePoints': 'Change (points)',
  'an.csvCohortNote': 'Same entities in both years only: {0}',
  'an.csvSources': 'Sources',
  'an.csvQuarterlyFigures': 'Quarterly figures',
  'an.csvSourceAllocations': 'Estimates of National Expenditure 2026, Vote 37, Table 37.3',
  'an.csvSourceOutcomes': 'Published annual reports and the Auditor-General briefing to the Portfolio Committee',
  'an.csvSourceQuarterly': 'Confirmed in Vuka by a named reporter',
  'er.confirmAll': 'Confirm all {0}',
  'er.confirmReady': 'Confirm {0} ready',
  'review.saveReason': 'Save the reason',
  'review.disputeSent': 'Disputed, already with the entity.',
  'review.disputeMarked': 'Marked as disputed.',
  'review.disputeNoReason': 'No reason recorded.',
  'review.disputeSentNote': 'This one was sent when the period was returned. Nothing further is needed here.',
  'review.disputeStagedNote': 'It goes back to the entity when you return the submission below. Nothing is sent yet.',
  'review.editReason': 'Edit the reason',
  'review.undoDispute': 'Undo this dispute',
  'sr.nextDraft': 'The entity has not submitted this period yet. Nothing can be approved or returned until they do.',
  'sr.nextClosed': 'This period is already {0}. It is here to read.',
  'sr.nextNothingMarked': 'Nothing is marked. Approving signs off all {0} figures in your name. To send one back, use Dispute this figure on the row.',
  'sr.nextOneMarked': 'One figure is marked. Returning sends it back with its reason; everything else stays as filed.',
  'sr.nextMarked': '{0} figures are marked. Returning sends those back with their reasons; everything else stays as filed.',
  'sr.returnOneFigure': 'Return 1 figure to the entity',
  'sr.returnNFigures': 'Return {0} figures to the entity',
  'sr.approveAll': 'Approve all {0} figures',
  'sr.notReturnedNothingSent': 'The submission was not returned. Nothing was sent.',
  'sr.notApprovedNothingChanged': 'The approval was not recorded. Nothing was changed.',
  'sr.doneReturnedOne': 'Returned to the entity with one figure to correct.',
  'sr.doneReturned': 'Returned to the entity with {0} figures to correct.',
  'sr.doneApproved': 'Approved. {0} is off the queue.',
  'sr.doneReturnQueued': 'The return is waiting to be sent and goes as soon as there is a connection.',
  'sr.doneApproveQueued': 'The approval is waiting to be sent and goes as soon as there is a connection.',
  'ask.open': 'Ask Vuka',
  'ask.what': 'It reads the figures this account can already see and answers from them. There is no language model behind it and nothing leaves the building, so every answer carries where it came from and a link to the screen that shows the working.',
  'ask.yourQuestion': 'Your question',
  'ask.submit': 'Ask',
  'ask.reading': 'Reading the portfolio.',
  'ask.canTake': 'Questions it can take',
  'ask.askSomethingElse': 'Ask something else',
  'ask.noMatch': 'Nothing on record answers that. Rather than guess at what you meant, here is everything this can answer.',
  'ask.orNameEntity': 'Or name any entity',
  'ask.qEntityExample': 'How is Iziko doing?',
  'ask.nothingComputed': 'Nothing has been computed for that yet.',
  'ask.nothingComputedSource': 'No stored figure answers this until a quarter has fallen due and risk has been scored.',
  'ask.theQuarter': 'the quarter under review',
  'ask.notOnRecord': 'not on record',
  'ask.noAllocationOnRecord': 'no allocation on record',
  'ask.namesAndMore': '{0} and {1} more',
  'ask.openEntity': 'Open {0}',
  'ask.qRisk': 'Which entities are critical?',
  'ask.aRisk': '{0} in the critical band and {1} in the high band, out of {2}.',
  'ask.aRiskCritical': 'Critical: {0}.',
  'ask.aRiskMoney': '{0} of this year’s allocation sits with them.',
  'ask.aRiskNoneCritical': 'No entity is in the critical band for the current scoring run.',
  'ask.aRiskHigh': 'High: {0}.',
  'ask.sRisk': 'Stored risk scores, computed from filing history, variance and audit outcomes. Bands are the published thresholds.',
  'ask.qMoney': 'How much money sits with entities at risk?',
  'ask.aMoney': '{0} sits with the {1} entities in the critical or high band.',
  'ask.aMoneyTotal': 'The portfolio total for the year is {0}, across {1} funded bodies.',
  'ask.sMoney': 'Allocations from the Estimates of National Expenditure 2026, Vote 37, Table 37.3. Bands from the stored risk scores.',
  'ask.qFiling': 'Who has not filed this quarter?',
  'ask.aFiling': '{0} of {1} filed on time for {2}.',
  'ask.aFilingSplit': '{0} late, {1} still not filed.',
  'ask.aFilingNothing': 'Nothing filed yet: {0}.',
  'ask.aFilingAllFiled': 'Every funded body has filed something for this quarter.',
  'ask.sFiling': 'Submission records against the due date the Department set for the period.',
  'ask.qWaiting': 'How many submissions are waiting for review?',
  'ask.aWaiting': '{0} waiting for a reviewer in {1}.',
  'ask.aWaitingSplit': '{0} approved, {1} returned to the entity for correction, {2} still in draft.',
  'ask.sWaiting': 'Submission status for the quarter under review.',
  'ask.qImproved': 'Is the portfolio getting better?',
  'ask.aImproved': 'Across the same {0} entities, targets achieved moved from {1} in {2} to {3} in {4}.',
  'ask.aImprovedSplit': '{0} improved, {1} declined.',
  'ask.aImprovedCohortNote': 'Only entities with published counts in both years are counted, so this is not a different population each year.',
  'ask.aImprovedNone': 'Not answerable yet.',
  'ask.aImprovedNoneDetail': 'Movement needs published targets-achieved counts for the same entity in two audited years. Fewer than two are on record.',
  'ask.sAudit': 'Published annual reports and the Auditor-General’s briefing to the Portfolio Committee.',
  'ask.qMovers': 'Who fell the most?',
  'ask.aMovers': '{0} fell furthest, {1} points, from {2} to {3}.',
  'ask.aMoversBest': '{0} improved most, up {1} points to {2}.',
  'ask.aMoversNoneImproved': 'No entity in the cohort improved between the two audited years.',
  'ask.sMovers': 'Published targets-achieved counts for the same entities in both audited years.',
  'ask.qSector': 'Which sector is doing best?',
  'ask.aSector': '{0} met the most quarter targets at {1}; {2} the fewest at {3}.',
  'ask.aSectorNote': 'Each entity is measured against its own targets, so this compares how well each sector keeps its own promises. It is not a comparison of what their outputs are worth, and the product does not compute a cost per outcome across a ballet company and a boxing regulator.',
  'ask.sSector': 'Figures confirmed in Vuka by a named reporter for {0}.',
  'ask.qAudit': 'What were the audit outcomes?',
  'ask.aAudit': 'In {0}: {1}.',
  'ask.aAuditRepeat': '{0} repeat findings are on record for that year.',
  'ask.sAuditBlank': 'Published annual reports and the Auditor-General’s briefing. Blank where not published; never inferred.',
  'ask.qNoTargets': 'Which entities have no targets registered?',
  'ask.aNoTargets': '{0} funded bodies have no target registered for {1}.',
  'ask.aNoTargetsNote': 'They still owe a quarterly report and are counted as expected, but they have nothing to report a figure against until an administrator loads their tabled Annual Performance Plan.',
  'ask.sNoTargets': 'Targets registered against the current financial year.',
  'ask.qTotal': 'What is the total allocation this year?',
  'ask.aTotal': '{0} across {1} funded bodies in {2}.',
  'ask.sTotal': 'Estimates of National Expenditure 2026, Vote 37, Table 37.3, current plus capital transfers.',
  'ask.aEntity': '{0} is in the {1} band{2}, with {3} this year.',
  'ask.aEntityScore': ', score {0}',
  'ask.aEntityPeriod': '{0}: {1}, {2} of {3} figures confirmed.',
  'ask.aEntityNothingFiled': '{0}: nothing filed.',
  'ask.aEntitySignal': 'Largest risk signal: {0}.',
  'ask.sEntity': 'The stored risk score for this entity and its submission record for the quarter.',
  'pf.toAnalytics': 'Analytics, charts and export',
} as const;
